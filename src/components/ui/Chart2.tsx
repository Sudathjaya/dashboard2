...
function plotChart(user1: any[], user2: any[]) {
  ...
  for (let index = 0; index < 300; index++) {
    ...
    if (record1) {
      singleRecord.user1 = record1.heart_rate;
    }
    if (record2) {
      singleRecord.user2 = record2.heart_rate;
    }
...
function plotChart2(user1: any[], user2: any[], user3: any[]) {
  ...
  for (let index = 0; index < 300; index++) {
    ...
    if (record3) {
      singleRecord.user3 = record3.heart_rate;
    }
    dataSet.push(singleRecord);
  }
  return dataSet;
...
export default function Chart(props: { userValue: any; fData: any; }) {
